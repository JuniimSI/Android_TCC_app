...
public class TutorialActivity extends AppIntro {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance("Iniciando a aplicação", "Para começar clique sobre a imagem do aplicativo e seja redirecionado para a tela de mapa", R.drawable.clique_para_iniciar, Color.parseColor("#1F51B5")));
        addSlide(AppIntroFragment.newInstance("Faça seu Login ", "Para realizar o login com o Google, basta clicar no botão e logar uma conta Google ", R.drawable.faca_seu_login, Color.parseColor("#1F51B5")));
        addSlide(AppIntroFragment.newInstance("Crie seus pontos", "Para criar seu ponto de interesse, toque e segure o local onde seu ponto deve ser cadastrado e preencha o formulário", R.drawable.insira_seu_ponto, Color.parseColor("#1F51B5")));
        addSlide(AppIntroFragment.newInstance("Edite seus pontos", "Para editar a localização de um ponto de interesse seu, basta clicar, segurar e arrastar", R.drawable.edite_seu_ponto, Color.parseColor("#1F51B5")));
        addSlide(AppIntroFragment.newInstance("Apague seus pontos", "Para apagar seu ponto de interesse, basta dar um clique no icone de lixeira na tela de detalhes de tal ponto", R.drawable.clique_para_apagar, Color.parseColor("#1F51B5")));
        addSlide(AppIntroFragment.newInstance("Veja informações rápidas", "Ao clicar em um ponto, surgirá uma janela de informações contendo suas principais informações", R.drawable.veja_sua_janela_de_informacoes, Color.parseColor("#1F51B5")));
