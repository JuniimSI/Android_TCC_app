...
public class TutorialActivity extends AppIntro {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance("Faça seu Login ", "Para realizar o login com o Google, basta clicar no botão e logar uma conta Google ", R.drawable.faca_seu_login, Color.parseColor("#BDC9E0")));
        ...
        addSlide(AppIntroFragment.newInstance("Calcule rotas", "Clique em um ponto de interesse, visualize a janela de informações e clique sobre a janela para gerar a rota", R.drawable.gere_sua_rota, Color.parseColor("#5472AE")));
        addSlide(AppIntroFragment.newInstance("Troque mensagens", "Para enviar uma mensagem, basta estar na tela de detalhes de um ponto, clicar no botão embaixo e escrever e enviar sua mensagem", R.drawable.insira_sua_mensagem, Color.parseColor("#CBD7EE")));
        addSlide(AppIntroFragment.newInstance("Edite, Apague e Responda", "Ao clicar e segurar sobre uma mensagem, surgirá este menu, com estas três operações, edição, delete e resposta", R.drawable.mensagens_menu, Color.parseColor("#CBD7EE")));
        ...
        addSlide(AppIntroFragment.newInstance("Dúvida?", "Em todas as telas contamos com este icone, o mesmo o trará de volta para a tela de tutorial, lhe dando todo o suporte necessario para uso da aplicação", R.drawable.tutorial, Color.parseColor("#CBD7EE")));
